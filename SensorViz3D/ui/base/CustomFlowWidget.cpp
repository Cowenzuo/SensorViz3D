...
void CustomFlowWidget::addItem(QWidget* itemWidget, bool asc/* = true*/, const QString& title /*= QString()*/) {
	...
	//auto item = new CustomFlowWidgetItem(itemWidget, title, _contentWidget);
